...
$(function(){
	(function(){
		...
		loadImage(['./images/head.png','./images/logo.png','./images/footbutton.png','./images/footbutton2.png','./images/footbutton3.png','./images/cx7car.png','./images/cx7cover.png','./images/cx7car2.png','./images/cx7car3.png'], function(){
				go();
		});
		function go(){
		...
		function developResize(){
			...
			$('.cx7 .word').stop().css('display','none');
			$('.cx7 ul').unbind();
			$('.cx7 .sstar').css('display','none');
		}
		//发展历程
		function develop(){
			$('.cx7 .sstar').css('display','none');
			...
			setTimeout(function(){
				$('.cx7 .sstar').fadeIn(700,startStar);
			},1000)			
			//定位
			$('.cx7').css('left',($('.content_body').width()/2)-($('.cx7').width()/2)+'px');
			$('.cx7').css('top',($('.content_body').height()/2)-(parseInt($('.cx7').css('paddingBottom'))/2)+7+'px');
			$('.cx7 ul').css('top',(parseInt($('.content_body .cx7').css('paddingBottom'))/2)-(parseInt($('.cx7 ul').css('height'))/2)+'px');
			...
			var attr='';
			var ssFlag=true;
			$('.cx7 ul').delegate("li","mouseenter",function(){
			...
			$('.cx7 ul').delegate("li","mouseleave",function(){
					if(ssFlag){
			...
			function biu(){
				...
				line.animate({
					'width':'100%'
				      ...
				      step: function(){
				        	var that = this;
				       	$('.cx7 span.sstar').each(function(index,ele) {
				...
				function set(){
					...
					$('.carLights .wordt').eq(0).css({
			 		...
			 		$('.carLights .wordt').eq(5).css({
			 	 	...
			 	 	$('.carLights .wordt').eq(6).css({
						'top':(parseInt($('.carLights .linet').eq(6).css('top'))-parseInt($('.carLights .wordt').eq(6).innerHeight()))+'px',
						'left':(parseInt($('.carLights .linet').eq(6).css('left'))-parseInt($('.carLights .wordt').eq(6).innerWidth()))+'px'
				 	});
				}
				set();
				$(window).resize(function(){
