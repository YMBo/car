...
$(function(){
	(function(){
		...
		loadImage(['./images/head.png','./images/logo.png','./images/footbutton.png','./images/footbutton2.png','./images/footbutton3.png','./images/m8car.png','./images/m8cover.png','./images/m8car2.png','./images/m8car3.png'], function(){
			go();
		});
		function go(){
		...
		function developResize(){
			...
			$('.m8 .word').stop().css('display','none');
			$('.m8 ul').unbind();
			$('.m8 .sstar').css('display','none');
		}
		//发展历程
		function develop(){
			$('.m8 .sstar').css('display','none');
			...
			setTimeout(function(){
				$('.m8 .sstar').fadeIn(700,startStar);
			},1000)			
			//定位
			$('.m8').css('left',($('.content_body').width()/2)-($('.m8').width()/2)+'px');
			$('.m8').css('top',($('.content_body').height()/2)-(parseInt($('.m8').css('paddingBottom'))/2)+'px');
			$('.m8 ul').css('top',(parseInt($('.content_body .m8').css('paddingBottom'))/2)-(parseInt($('.m8 ul').css('height'))/2)+7+'px');
			...
			var attr='';
			var ssFlag=true;
			$('.m8 ul').delegate("li","mouseenter",function(){
			...
			$('.m8 ul').delegate("li","mouseleave",function(){
					if(ssFlag){
			...
			function biu(){
				...
				line.animate({
					'width':'100%'
				      ...
				      step: function(){
				        	var that = this;
				       	$('.m8 span.sstar').each(function(index,ele) {
			...
			function setPosition(){
				...
				function set(){
					...
					$('.ohistory').css({
						...
						'top':($('.content_body').height()/2)-(parseInt($('.ohistory').css('paddingBottom'))/2)+'px'
					...
					$('.ohistory .popup').css({
						...
						'top':parseInt($('.ohistory').css('paddingBottom'))/2-20-parseInt($('.ohistory .popup').css('paddingBottom'))/2+7+'px'
					})
					...
					$('.ohistory .wordt3').eq(0).css({
			 		...
			 		$('.ohistory .wordt3').eq(5).css({
			 			...
			 			'left':(parseInt($('.ohistory .linet3').eq(5).css('left'))+parseInt($('.ohistory .linet3').eq(6).innerWidth())/2)+'px'
			 	 	});
