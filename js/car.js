...
$(function(){
	(function(){
		...
		loadImage(['./images/head.png','./images/logo.png','./images/footbutton.png','./images/footbutton2.png','./images/footbutton3.png','./images/m6car.png','./images/m6cover.png','./images/m6car2.png','./images/m6car3.png'], function(){	
				go();
		});
		function go(){
		...
		function develop(){
			...
			//定位
			$('.m6').css('left',($('.content_body').width()/2)-($('.m6').width()/2)+'px');
			$('.m6').css('top',($('.content_body').height()/2)-(parseInt($('.m6').css('paddingBottom'))/2)+7+'px');
			$('.m6 ul').css('top',(parseInt($('.content_body .m6').css('paddingBottom'))/2)-(parseInt($('.m6 ul').css('height'))/2)+'px');
			...
			var attr='';
			var ssFlag=true;
			$('.m6 ul').delegate("li","mouseenter",function(){
			...
			$('.m6 ul').delegate("li","mouseleave",function(){
					if(ssFlag){
			...
			function biu(){
				...
				line.animate({
					'width':'100%'
				      ...
				      step: function(){
				        	var that = this;
				       	$('.m6 span.sstar').each(function(index,ele) {
				...
				function set(){
					...
					$('.carLights .wordt').eq(0).css({
			 		...
			 		$('.carLights .wordt').eq(1).css({
			 			'top':(parseInt($('.carLights .linet').eq(1).css('top'))+parseInt($('.carLights .linet').eq(1).innerHeight()))+'px',
					...
					$('.ohistory .wordt3').eq(0).css({
			 		...
			 		$('.ohistory .wordt3').eq(5).css({
			 	 	...
			 	 	$('.ohistory .wordt3').eq(8).css({
			 			'top':(parseInt($('.ohistory .linet3').eq(8).css('top'))-parseInt($('.ohistory .wordt3').eq(8).innerHeight())/2)+'px',
			 			'left':(parseInt($('.ohistory .linet3').eq(8).css('left'))-parseInt($('.ohistory .wordt3').eq(8).innerWidth()))+'px'
			 	 	});
			 	 	$('.ohistory .wordt3').eq(9).css({
			 			'top':(parseInt($('.ohistory .linet3').eq(9).css('top'))+parseInt($('.ohistory .linet3').eq(9).innerHeight()))+'px',
			 			'left':(parseInt($('.ohistory .linet3').eq(9).css('left'))-parseInt($('.ohistory .wordt3').eq(9).innerWidth())/2)+'px'
			 	 	});
			 	 	$('.ohistory .wordt3').eq(10).css({
			 			'top':(parseInt($('.ohistory .linet3').eq(10).css('top'))-parseInt($('.ohistory .wordt3').eq(10).innerHeight()))+'px',
			 			'left':(parseInt($('.ohistory .linet3').eq(10).css('left'))-parseInt($('.ohistory .wordt3').eq(10).innerWidth())/2)+'px'
			 	 	});
			 	 	$('.ohistory .wordt3').eq(11).css({
			 			'top':(parseInt($('.ohistory .linet3').eq(11).css('top'))-parseInt($('.ohistory .wordt3').eq(11).innerHeight()))+'px',
			 			'left':(parseInt($('.ohistory .linet3').eq(11).css('left'))-parseInt($('.ohistory .wordt3').eq(11).innerWidth())/2)+'px'
			 	 	});
			 	 	$('.ohistory .wordt3').eq(12).css({
			 			'top':(parseInt($('.ohistory .linet3').eq(12).css('top'))+parseInt($('.ohistory .linet3').eq(12).innerHeight()))+'px',
			 			'left':(parseInt($('.ohistory .linet3').eq(12).css('left'))+parseInt($('.ohistory .linet3').eq(12).innerWidth())/2)+'px'
			 	 	});
			 	 	$('.ohistory .wordt3').eq(13).css({
			 			'top':(parseInt($('.ohistory .linet3').eq(13).css('top'))+parseInt($('.ohistory .linet3').eq(13).innerHeight()))+'px',
			 			'left':(parseInt($('.ohistory .linet3').eq(13).css('left'))+parseInt($('.ohistory .linet3').eq(13).innerWidth())/2)+'px'
			 	 	});
			 	 	$('.ohistory .wordt3').eq(14).css({
			 			'top':(parseInt($('.ohistory .linet3').eq(14).css('top'))+parseInt($('.ohistory .linet3').eq(14).innerHeight()))+'px',
			 			'left':(parseInt($('.ohistory .linet3').eq(14).css('left'))+parseInt($('.ohistory .linet3').eq(14).innerWidth())/2)+'px'
			 	 	});
				}
				$(window).resize(function(){
					set();
